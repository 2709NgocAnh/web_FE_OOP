...
// return ({listorderstatus?.map((status) => {
// return (
// <button
// style={{
//   backgroundColor: "#0d6efd",
...
//  >
//    {status.name}
//    </button>)})})}else if(orderStatus=== "processing"){
//      return(
//      {listorderstatus?.map((status) => {
//          return (
// <button
//  disabled={ status.name==="pending"?true:false}
...
//  >
//  {status.name}
//  </button>)})})else if(orderStatus=== "shipping"){
// <button
// disabled={  status.name==="pending"||status.name==="processing"?true:false}
// style={{
// backgroundColor: "#0d6efd",
// opacity: status.id == orderstatus ? "0.5" : "1",
// color: "white",
...
// <button
//      disabled={ status.name==="pending"||status.name==="processing"||status.name==="shipping"?true:false}
// style={{
// backgroundColor: "#0d6efd",
//  opacity: status.id == orderstatus ? "0.5" : "1",
//    color: "white",
...
//   <button
//          disabled={ status.name==="pending"||status.name==="processing"||status.name==="shipping"||status.name==="cancelled"?true:false}
